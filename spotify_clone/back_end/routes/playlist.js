...
router.post("/create" , passport.authenticate("jwt" , {session: false}), async(req,res) =>{
    ...
    {
        return res.status(301).json({err: "Data not found or insufficient data"});
    }
...
router.get("/get/playlist/:getPlaylistID", passport.authenticate("jwt" , {session: false}), async (req,res)=> {
